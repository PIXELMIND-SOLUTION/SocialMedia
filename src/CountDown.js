...
const CountdownTimer = () => {
  ...
  const targetDate = new Date("2025-12-31T16:40:00");
  ...
  return (
    <div className="fixed inset-0 z-[9999] overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="text-center px-6 py-12 rounded-3xl bg-gradient-to-br from-black/60 to-gray-900/60 backdrop-blur-2xl border border-white/10 shadow-2xl max-w-2xl mx-auto">
          {!ended ? (
            <>
...
<div className="max-w-lg mx-auto mb-6">
  ...
  <div className="space-y-5">
    <h2 className="text-5xl sm:text-6xl md:text-7xl font-extrabold leading-tight">
      <span className="block bg-gradient-to-r from-yellow-300 via-orange-400 to-pink-500 bg-clip-text text-transparent animate-gradient drop-shadow-[0_0_30px_rgba(255,165,0,0.5)]">
        🎉 WE ARE LIVE 🎉
      </span>
    </h2>
